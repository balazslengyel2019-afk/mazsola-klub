...
public class MainActivity extends Activity {
    ...
    private SynthViewV24 synthView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        audio = new SampleEngine(this); // keep the approved v2.3 instrument/audio engine unchanged
        showIntro();
    }
    ...
    private void showSynth() {
        ...
        try {
            synthView = new SynthViewV24(this, audio);
